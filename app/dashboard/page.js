                    ...
                    <div className=" flex items-center justify-between flex-row  w-full p-3 ">
                        ...
                        <div className="flex justify-center">
                            <details className="relative inline-block text-left">
                                <summary
                                    className="list-none w-12 h-12 flex justify-center items-center bg-blue-500 text-white rounded-full shadow-sm hover:bg-blue-600 transition-all cursor-pointer">
